...
starlette_websocket_provider = providers.ContextProvider(
    scope=Scope.SESSION, context_type=starlette.websockets.WebSocket
)
...
def inject(func):
    ...
    async def wrapper(connection):  # Request or WebSocket
        ...
        di = {
            name: (
                child.resolve_provider(m.provider)
